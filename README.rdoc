...
* The Blacklight plugin ( http://github.com/projectblacklight/blacklight )
  * NOTE: That Blacklight version 2.5 or greater is recommended in order to appropriately load the necessary JavaScript and CSS into the application level.  If you are running on an older version of Blacklight you will need to manually include the advanced search plugin's JavaScript and CSS files manually.
