...
The 'generate' command will copy some stylesheet/javascript assets to your local app (this architecture will likely change for Rails 3.1), and also install a config/initializers/blacklight_advanced_search.rb . Configuration in the initializer is optional, for many setups no configuration will be neccesary. See 'Configuration' section below. 
